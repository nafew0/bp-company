...
MIDDLEWARE = [
    ...
    "bp_company.middleware.ContentSecurityPolicyMiddleware",
]

ROOT_URLCONF = "bp_company.urls"
...
WSGI_APPLICATION = "bp_company.wsgi.application"
ASGI_APPLICATION = "bp_company.asgi.application"
