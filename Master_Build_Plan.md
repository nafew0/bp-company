...
**Work**
1. Clone `bp-company` → new working copy; re-point `origin` to `https://github.com/nafew0/applelab.git`; add `template` remote (§1.3); in `bp-company` add the `applelab` remote. Push.
